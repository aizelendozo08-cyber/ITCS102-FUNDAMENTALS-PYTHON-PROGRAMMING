                                ...
                                if do_you == 'yes':
                                    while True:
                                        ...
                                        if explore_pri_func == '1':
                                            ...
                                            print('output:')
                                            print('\tMy name is Aizel and I am 18 years old.')
                                            print('______________________________________________________________')
                        ...
                        if do_you == 'yes':
                            while True:
                                ...
                                if _data_types == '1':
                                    ...
                                    if example == 'yes':
                                        print('\nExample:')
                                        print('\tstudent = {"name":"Aizel","age": 18,"course":"BSIT"}')
                                        print('\nAccessing Dictionary Values')
                                        print('\n\tprint(student["name"])\n\tprint(student["age"])')
                                        print('Output:\n\tAizel\n\t18')
                                        print('\nAdding New Key-Value Pair')
                                        print('\n\tstudent["section"]="A"\n\tprint(student)')
                                        print('Output:\n\t{"name": "Aizel", "age": 18, "section": "A"}')
                                        print('\nChangin an Existing Value')
                                        print('\n\tstudent["section"]="B"')
                                        print('Output:\n\t{"name": "Aizel", "age": 18, "section": "B"}')
